...
/*
void CContactsPane::setFriendList(const QVector<FRIENDINFO>& vFriendInfo)
{
	if (m_pFriendsList)
	{
		m_pFriendsList->setFriendList(vFriendInfo);
	}
	qDebug() << "CContactsPane isVisible" << this->isVisible();
}
*/
